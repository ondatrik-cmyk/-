...
# Завдання 2.
# Провести аналіз:за перевізниками,за країнами доставки.
# На основі таблиці shipments розрахувати термін доставки:
...
print("Перелік перевізників та країн доставки")
print(full_data)
